! Timeseries for different values of w
	...
	integer, parameter :: tran=480000,iter=500000
	...
	double precision   :: KE,PE,H,H0,U0,pRange,ravg,rsqr
	...
	open (unit=2,file='timeseries.dat')
	...
	U0=0.4d0; H0=U0*mm;ravg=0;rsqr=0.0
